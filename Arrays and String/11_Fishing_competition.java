...
public class UserInterface 
{
    public static void main(String args[]) 
    {
        ...
        String participantName = details[0];
        int participantAge;
        int BigFishCount;
        int MediumFishCount;
        int SmallFishCount;
        ...
        try{
            participantAge =Integer.parseInt(details[1]);
            BigFishCount =Integer.parseInt(details[2]);
            MediumFishCount =Integer.parseInt(details[3]);
            SmallFishCount =Integer.parseInt(details[4]);
        ...
        int totalPoints = (BigFishCount * 10) + (MediumFishCount * 6) + (SmallFishCount * 3);
        
        System.out.println(participantName + " scored " + totalPoints + " points");
